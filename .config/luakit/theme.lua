...
-- Default settings
theme.font = "12px JetBrainsMono NF"
theme.fg   = "#fff"
theme.bg   = "#1e1e2e"
theme.text = "#cdd6f4"
...
theme.menu_bg                   = "#181825"
theme.menu_selected_fg          = "#9399b2"
...
theme.warn = { fg = "#f9e2af", bg = "#FFF" }
theme.error = { fg = "#f38ba8", bg = "#F00" }
